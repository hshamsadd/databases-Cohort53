...
1.  **One-to-One (1:1): A Perfect Pair**
    ...
    *   It's like a perfect pair. For example, one person has one passport, and that passport belongs to only one person.
    ...
    <p align="center">
    <img src="./images/10.png" alt="Students table" width="200"/>
    </p>
...
3.  **To create the M:N relationship in a database, you need a hidden junction table:**

    <p align="center">
    <img src="./images/14.png" alt="Students table" width="200"/>
    </p>
