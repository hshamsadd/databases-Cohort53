...
-- ------------------------------------------------------
-- Originally from MySQL 5.1.51-debug-log, converted to PostgreSQL format
...
CREATE TABLE country (
  ...
  Continent VARCHAR(20) NOT NULL DEFAULT 'Asia' CHECK (Continent IN ('Asia','Europe','North America','Africa','Oceania','Antarctica','South America')),
...
INSERT INTO countrylanguage VALUES ('BOL','Aimar�',TRUE,3.2);
INSERT INTO countrylanguage VALUES ('BOL','Guaran�',FALSE,0.1);
...
INSERT INTO countrylanguage VALUES ('CHL','Aimar�',FALSE,0.5);
...
INSERT INTO countrylanguage VALUES ('GTM','Kekch�',FALSE,4.9);
INSERT INTO countrylanguage VALUES ('GTM','Mam',FALSE,2.7);
INSERT INTO countrylanguage VALUES ('GTM','Quich�',FALSE,10.1);
...
INSERT INTO countrylanguage VALUES ('MEX','N�huatl',FALSE,1.8);
INSERT INTO countrylanguage VALUES ('MEX','Otom�',FALSE,0.4);
...
INSERT INTO countrylanguage VALUES ('MYT','Mahor�',FALSE,41.9);
...
INSERT INTO countrylanguage VALUES ('PRY','Guaran�',TRUE,40.1);
...
INSERT INTO countrylanguage VALUES ('TGO','Kaby�',TRUE,13.8);
...
ALTER TABLE city ADD CONSTRAINT city_country_fk 
  FOREIGN KEY (CountryCode) REFERENCES country (Code);

ALTER TABLE countrylanguage ADD CONSTRAINT countrylanguage_country_fk 
  FOREIGN KEY (CountryCode) REFERENCES country (Code);

-- Add indexes for better performance
CREATE INDEX city_countrycode_idx ON city (CountryCode);
CREATE INDEX countrylanguage_countrycode_idx ON countrylanguage (CountryCode);

-- Dump completed on 2010-09-30 11:01:37 (converted to PostgreSQL format)
